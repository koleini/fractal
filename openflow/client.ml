...
let main () =
    ...
    in
    try_lwt 
        lwt src_c = lwt_the "Error creating controller" (create_controller (Ipaddr.V4.of_string_exn "10.20.0.9")) in
        lwt dst_c = lwt_the "Error creating controller" (create_controller (Ipaddr.V4.of_string_exn "10.20.0.101")) in
